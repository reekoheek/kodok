...
define("vendor/require/require", function(){});
...
define('core/router',['backbone'], function() {
    var Router = Backbone.Router.extend({
        ...
        _default: function(actions) {
            ...
            if (actions[0] == '/') {
                ...
                require(['mod!' + segments.slice(1).join('/')], function(Module) {
    ...
    return {
        ...
        load: function (name, req, onload, config) {
            text.get(req.toUrl(name), function(data){
                ...
                onload(JSON.parse(newdata.join('\n')));
            });
        }
    };
});
...
if (typeof define == 'undefined') {
    ...
    define('kodok', ['core/router', 'backbone'], function(Router) {
        Kodok.Router = Router;
        return  Kodok;
    });
};
